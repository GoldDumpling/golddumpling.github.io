...
(function(){
	...
	var Memory = {
		...
		buildHTML: function(){
			...
			this.$cards.each(function(k, v){
				...
				alt="'+ v.name +'" /></div>\
				<div class="back"><img src="\abspace\css\Ёж.png"\
				alt="Codepen" /></div></div>\
				</div>';
			});
	...
	var cards = [
		...
		{
			name: "css3",
			img: "\abspace\css\Planet_Mercury_-_GPN-2000-000465.jpg",
			id: 2
		},
		{
			name: "html5",
			img: "\abspace\css\Venus_globe.jpg",
			id: 3
		},
		{
			name: "jquery",
			img: "\abspace\css\The_Earth_seen_from_Apollo_17.jpg",
			id: 4
		}, 
		{
			name: "javascript",
			img: "\abspace\css\Mars_Hubble.jpg",
			id: 5
		},
		{
			name: "node",
			img: "\abspace\css\Jupiter_Auroras.jpg",
			id: 6
		},
		{
			name: "photoshop",
		...
		{
			name: "python",
			img: "\abspace\css\Satur_with_auroras.jpg",
			id: 8
		},
		{
			name: "rails",
			img: "\abspace\css\Uranus_clouds.jpg",
			id: 9
		},
		{
			name: "sass",
			img: "\abspace\css\Neptune_Voyager2_color_calibrated.png",
			id: 10
		},
	];
